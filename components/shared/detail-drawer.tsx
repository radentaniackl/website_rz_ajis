...
export interface DetailDrawerProps<T extends { id: number | string }> {
  open: boolean;
...
export function DetailDrawer<T extends { id: number | string }>({ open, onOpenChange, title, row, fields }: DetailDrawerProps<T>) {
  return (
