...
import { RefPropinsiActions } from './ref-propinsi-actions';
import { ChevronLeft, ChevronRight } from 'lucide-react';
import Link from 'next/link';

interface RefPropinsiTableProps {
  data: Array<{
    id: bigint;
    kode: string;
    nama: string;
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Nama Propinsi</TableHead>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {currentPage === 1 ? (
            ...
            <Link href={`/dashboard/referensi/propinsi?page=${currentPage - 1}`}>
            ...
            {Array.from({ length: Math.min(5, totalPages) }).map((_, i) => {
              ...
              return (
                currentPage === pageNum ? (
                  ...
                  <Link key={pageNum} href={`/dashboard/referensi/propinsi?page=${pageNum}`}>
                    <Button variant="outline" size="sm">
                      {pageNum}
                    </Button>
                  </Link>
